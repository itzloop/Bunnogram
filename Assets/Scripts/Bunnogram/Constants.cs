namespace Bunnogram
{
    ...
    {
        public static string ClickModeKey = "click_mode";
        public static string HealthPointKey = "health_point";
        public static string HintsCountKey = "hint_count";
        public static string GameStatesKey = "game_states";
